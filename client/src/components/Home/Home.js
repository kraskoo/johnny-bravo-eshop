        ...
        <div id="carousel" className="carousel slide" data-ride="carousel">
          ...
          <div className="carousel-inner">
            <div className="item active">
              <img src="carousel/1.png" alt="Los Angeles" />
            </div>
            <div className="item">
              <img src="carousel/2.png" alt="Chicago" />
            </div>
            <div className="item">
              <img src="carousel/3.png" alt="New York" />
            </div>
            <div className="item">
              <img src="carousel/4.png" alt="New York" />
            </div>
            <div className="item">
              <img src="carousel/5.png" alt="New York" />
            </div>
            <div className="item">
              <img src="carousel/6.png" alt="New York" />
            </div>
          </div>
